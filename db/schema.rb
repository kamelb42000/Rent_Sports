...
ActiveRecord::Schema[7.0].define(version: 2023_05_29_123959) do
  ...
  create_table "equipment", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["categorie_id"], name: "index_equipment_on_categorie_id"
  ...
  add_foreign_key "equipment", "categories", column: "categorie_id"
